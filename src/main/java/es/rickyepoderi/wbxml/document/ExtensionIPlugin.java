...
/**
 * <p>Extension plugin for managing EXT_I extensions inside the WBXML.
 * This extensions have associated a character dependant string.</p>
 * 
 * <pre>
 * EXT_I termstr
 ...
 * names. The different EXT_I_[012] are used to different types or variables
...
public interface ExtensionIPlugin {
    ...
    /**
     * The method to parse an EXT_I inside a content. The method should
    ...
    /**
     * The method to parse an EXT_I inside an attribute. The method should
