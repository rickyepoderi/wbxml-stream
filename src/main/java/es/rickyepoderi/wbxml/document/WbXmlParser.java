...
//     * used in the parsing. The method used all the definitions (the main one
//     * and the linked).
//     * @param namespaceURI The namespaceURI to locate a prefix from
//     * @return The prefix or null
//     */
//    public String getPrefix(String namespaceURI) {
//        String prefix = doc.getDefinition().getPrefix(namespaceURI);
//        if (prefix != null) {
//            return prefix;
//        }
//        for (WbXmlDefinition def : doc.getDefinition().getLinkedDefs()) {
...
//        String namespaceURI = doc.getDefinition().getNamespaceURI(prefix);
...
//        Set<WbXmlAttributeDef> attrDefs = doc.getDefinition().locateAttribute(name);
//        if (attrDefs != null) {
//            return attrDefs;
//        }
//        for (WbXmlDefinition def: doc.getDefinition().getLinkedDefs()) {
//            attrDefs = def.locateAttribute(name);
//            if (attrDefs != null) {
//                return attrDefs;
//            }
//        }
...
//        WbXmlTagDef tagDef = doc.getDefinition().locateTag(tag);
//        if (tagDef != null) {
//            return tagDef;
//        }
//        for (WbXmlDefinition def : doc.getDefinition().getLinkedDefs()) {
//            tagDef = def.locateTag(tag);
//            if (tagDef != null) {
//                return tagDef;
//            }
//        }
...
//        String root = doc.getDefinition().getRootName();
//        if (tag.equals(root)) {
//            return doc.getDefinition().getNamespaces();
//        }
//        for (WbXmlDefinition def : doc.getDefinition().getLinkedDefs()) {
//            root = def.getRootName();
//            if (tag.equals(root)) {
