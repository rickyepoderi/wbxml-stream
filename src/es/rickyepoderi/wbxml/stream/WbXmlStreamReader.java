...
public class WbXmlStreamReader implements XMLStreamReader {
    ...
    public WbXmlStreamReader(WbXmlParser parser) {
        ...
        // add namespaces
        for (WbXmlDefinition def: parser.getdefinitionsUsed()) {
    ...
    public String getAttributeValue(String namespaceURI, String localName) {
        ...
        if (namespaceURI != null && !namespaceURI.isEmpty()) {
            String prefix = parser.getPrefix(namespaceURI);
    ...
    public QName getAttributeName(int i) {
        ...
        if (attr != null) {
            if (attr.isPrefixed()) {
                ...
                String namespaceURI = parser.getNamespaceURI(prefix);
    ...
    public String getAttributeNamespace(int i) {
        ...
        if (attr != null) {
            if (attr.isPrefixed()) {
                // it has a prefix
                result = parser.getNamespaceURI(attr.getNamePrefix());
            } else {
     ...
     * or NAMESPACE. On an END_ELEMENT the count is of the namespaces that are 
     * about to go out of scope. This is the equivalent of the information 
     * reported by SAX callback for an end element event.</p>
     * 
    ...
    public int getNamespaceCount() {
        ...
        if (event != START_ELEMENT && event != END_ELEMENT) {
            throw new IllegalStateException("No in START_ELEMENT or END_ELEMENT.");
        } else {
            Collection<WbXmlNamespaceDef> ns = parser.getNamespacesForTag(elementIndex.currentElement.getTag());
            if (ns != null) {
                result = ns.size();
            }
        }
     ...
     * language definition element has namespaces.
     * 
    ...
    public String getNamespacePrefix(int i) {
        ...
        if (event != START_ELEMENT && event != END_ELEMENT) {
            ...
            Collection<WbXmlNamespaceDef> ns = parser.getNamespacesForTag(elementIndex.currentElement.getTag());
            if (ns != null) {
                result = ns.toArray(new WbXmlNamespaceDef[0])[i].getPrefix();
            }
        }
        log.log(Level.FINE, "getNamespaceCount(): {0}", result);
        return result;
    ...
    public String getNamespaceURI(int i) {
        ...
        if (event != START_ELEMENT && event != END_ELEMENT) {
            ...
            Collection<WbXmlNamespaceDef> ns = parser.getNamespacesForTag(elementIndex.currentElement.getTag());
            if (ns != null) {
                result = ns.toArray(new WbXmlNamespaceDef[0])[i].getNamespace();
            }
        }
        log.log(Level.FINE, "getNamespaceCount(): {0}", result);
        return result;
    ...
    public String getNamespaceURI() {
        ...
        if (event == START_ELEMENT || event == END_ELEMENT) {
            if (elementIndex.currentElement.isPrefixed()) {
                String prefix = elementIndex.currentElement.getTagPrefix();
                namespace = parser.getNamespaceURI(prefix);
            } else {
