 ...
 * @author ricky
 */
public class Channel11Test extends GenericDirectoryTester {
    
    public Channel11Test() {
        super("src/test/examples/channel11", 
                WbXmlInitialization.getDefinitionByName("CHANNEL 1.1"));
    }
