 ...
 * @author ricky
 */
public class WbXml10Example2Test extends GenericDirectoryTester {
    
    public WbXml10Example2Test() throws IOException {
        super("src/test/examples/spec-examples/example2-10", null);
